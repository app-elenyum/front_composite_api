<template>
  <div class="flex flex-column gap-2 px-2 mb-3">
    ...
    <input class="p-inputtext p-component p-inputtext-sm" placeholder="Enter greater than or equal" type="number"
           v-model="model"/>
...
function validate() {
  if (!!model.value === false) {
    errors.value.push('Error: Greater than or equal is empty');
    return false
  }
  return true;
}
